...
const DiseaseDetail: React.FC = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="bg-gradient-to-r from-pink-50 to-purple-50 dark:from-pink-900/20 dark:to-purple-900/20 rounded-2xl p-8 mb-8 border border-pink-100 dark:border-pink-800">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-white/50 dark:bg-gray-800/50 rounded-xl p-6">
            ...
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
              {disease.simpleExplanation.whatIs}
            </p>
          </div>
          ...
          <div className="bg-white/50 dark:bg-gray-800/50 rounded-xl p-6">
            ...
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
              {disease.simpleExplanation.howYouGet}
            </p>
          </div>
          ...
          <div className="bg-white/50 dark:bg-gray-800/50 rounded-xl p-6">
            ...
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
              {disease.simpleExplanation.howToFeel}
            </p>
          </div>
          ...
          <div className="bg-white/50 dark:bg-gray-800/50 rounded-xl p-6">
            ...
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
              {disease.simpleExplanation.howToGetBetter}
            </p>
          </div>
        </div>
      </div>
